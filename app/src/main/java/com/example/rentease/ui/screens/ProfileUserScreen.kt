...
fun ProfileUserScreen(
    ...
    GalaxyBackground(starAlpha = 0.3f) {
        Column(
            ...
            AppToolbar(title = "Profile Saya", onBackClick = onBack)
            ...
            if (loading) {
                ...
                Column(
                    ...
                    InfoRow(icon = Icons.Default.VpnKey, label = "NIK", value = nik)
                    InfoRow(icon = Icons.Default.Home, label = "Alamat", value = address)
    ...
    if (showLogoutDialog) {
        AlertDialog(
            ...
            title = { Text("Keluar Akun", color = TextDark) },
